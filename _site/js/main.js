...
ltrainvintage.bindPopup("<b>L Train Vintage</b><br>106 Knickerbocker Ave, Brooklyn, NY 11237, United States").openPopup();

var goodwill = L.marker([40.744334,-73.992507]).addTo(mymap);

goodwill.bindPopup("<b>Good Will</b><br>103 W 25th St, New York, NY 10001, United States").openPopup();

var buffaloexchange = L.marker([40.7254032,-73.9964979]).addTo(mymap);

buffaloexchange.bindPopup("<b>Buffalo Exchange</b><br>714 Broadway, New York, NY 10003, United States").openPopup();

var beaconscloset = L.marker([40.734922,-73.9941588]).addTo(mymap);

beaconscloset.bindPopup("<b>Beacon's Closet</b><br>10 W 13th St, New York, NY 10011, United States").openPopup();